              ...
              <div className="flex items-center gap-1">
                {!card.noArrow && (
                  <svg className={`size-3.5 shrink-0 ${card.positive ? "text-[#027a48]" : "text-[#b42318]"}`} viewBox="0 0 14 14" fill="none">
                    {card.positive ? <path d="M7 11V3M7 3L3 7M7 3L11 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/> : <path d="M7 3V11M7 11L3 7M7 11L11 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>}
                  </svg>
                )}
          ...
          {metrics.latestHealthScore != null ? (
            <div className="flex flex-col gap-4">
              ...
              <div className="w-full bg-[#eaecf0] rounded-full h-3">
                <div className="h-3 rounded-full transition-all duration-700" style={{ width: `${metrics.latestHealthScore}%`, background: metrics.latestHealthScore >= 70 ? "#027a48" : metrics.latestHealthScore >= 40 ? "#dc6803" : "#b42318" }} />
              </div>
