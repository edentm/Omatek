import svgPaths from "./svg-h1rtfgog9m";
import imgUntitledDesign41 from "./f3bfc5197c2b5c175bc0831b10ffdf71cbe9c3a3.png";
...
function Icon7() {
  return (
    <div className="absolute left-[13.2px] size-[16px] top-[13.2px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p3b397100} id="Vector" stroke="var(--stroke-0, #344054)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Button10() {
  return (
    <div className="absolute bg-white border-[#d0d5dd] border-[0.8px] border-solid h-[43px] left-[953px] rounded-[10px] top-[37px] w-[268px]" data-name="button">
      <p className="-translate-x-1/2 absolute font-['Figtree:Regular',sans-serif] font-normal leading-[21px] left-[calc(50%+7px)] text-[#344054] text-[14px] text-center top-[calc(50%-10.5px)] whitespace-nowrap">Upload and Analyze Documents</p>
      <Icon7 />
    </div>
  );
}
...
function Container35() {
  return (
    <div className="absolute border-[#eaecf0] border-b-[0.5px] border-solid h-[77px] left-0 top-0 w-[186.203px]" data-name="Container">
      <Container36 />
      <div className="absolute h-[59px] left-[20px] top-[8px] w-[108px]" data-name="Untitled design (4) 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[340%] left-[-41.03%] max-w-none top-[-117.06%] w-[185.26%]" src={imgUntitledDesign41} />
        </div>
      </div>
    </div>
  );
